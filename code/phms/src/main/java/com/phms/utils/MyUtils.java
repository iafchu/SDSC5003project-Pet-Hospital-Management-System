...
public class MyUtils {
	 ...
	 * Description: 判断是不是email,是就Backtrue <BR>
	 * Remark: <BR>
	 * 
	 * @param email
	 * @return boolean<BR>
	 ...
	 * Description: 判断手机号是不是正确,是就Backtrue <BR>
	 * Remark: <BR>
	 * 
	 * @param phoneNume
	 * @return boolean<BR>
	 ...
	 * Description: Back当前日期和时间yyyy-MM-dd HH:mm:ss <BR>
	 * Remark: <BR>
	 * 
	 * @return String<BR>
	 */
	 ...
	 * Description: Back当前日期和时间 yyyy-MM-dd <BR>
	 * Remark: <BR>
	 * 
	 * @return String<BR>
	 */
	 ...
	 * Description: Back当前日期和时间 yyyy年MM月dd日<BR>
	 * Remark: <BR>
	 * 
	 * @return String<BR>
	 */
	...
	public static synchronized String getAutoNumber() {
		...
		try {
			...
			try {
				...
				logger.error("根据时间获取编号出现Abnormal", e);
			}
	 ...
	 * Remark: 如2018-09-01 和 2018-09-017 Back就是17天<BR>
	 * 
	 * @param startDate
	 * @param endDate
	 * @return int<BR>
	...
	public static int get2DateDay(String startDate, String endDate) {
		...
		try {
			...
			logger.error("获取两个日期之间的天数出现Abnormal", e);
		}
	 ...
	 * Description: 根据字符串转成日期typeyyyt-MM-dd <BR>
	 * 
	 * @param time
	 * @return Date<BR>
	 */
	...
	/**
	 * Method name: getStringDate <BR>
	 * Description: 根据字符串转成日期typeyyyt-MM-dd HH:mm:ss<BR>
	 * 
	 * @param time
	 * @return Date<BR>
	 */
