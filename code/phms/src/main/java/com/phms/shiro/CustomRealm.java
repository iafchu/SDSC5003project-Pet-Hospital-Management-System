...
public class CustomRealm extends AuthorizingRealm {
	 ...
	 *      获取身份验证信息 Description: Shiro中，最终是Pass Realm 来获取应用程序中的用户、角色及权限信息的。 <BR>
	 * @param authenticationToken 用户身份信息 token
	 * @return Back封装了用户信息的 AuthenticationInfo 实例
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken)
		...
		if (null == password) {
			...
			logger.warn("{}---输入password错误", token.getUsername());
			// 向前台抛出输入password错误json对象
