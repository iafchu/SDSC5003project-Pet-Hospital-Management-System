...
public class RoleServiceImpl implements RoleService {
	...
	public String addRole(String name) {
		...
		try {
			...
			logger.error("添加角色Abnormal", e);
			return "ERROR";
		}
	}

	/**
	 *      Description: 根据权限idDELETE权限 <BR>
	 *      Remark: <BR>
	 * @param id
	 * @return <BR>
	 */
	...
	public boolean delRoleById(Integer id) {
		try {
			...
			TransactionAspectSupport.currentTransactionStatus().setRollbackOnly();
			logger.error("根据权限idDELETE权限Abnormal", e);
			return false;
		}
	}
	...
	public int updateRoleById(Integer id, String name) {
		...
		try {
			...
			TransactionAspectSupport.currentTransactionStatus().setRollbackOnly();
			logger.error("根据权限id更新权限Abnormal", e);
			return 0;
		}
	}
}