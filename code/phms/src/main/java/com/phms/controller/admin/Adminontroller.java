...
public class Adminontroller {
	 ...
	 * Description: 根据角色query下面所有的人员/非角色下所有人员 <BR>
	 */
	 ...
	 * Description: 根据用户id权限idDELETE用户权限表 <BR>
	 * 
	 * @param userId
	 * @param roleId
	 * @return ResultMap<BR>
	 ...
	 * Description: 跳转到选择用户Character page <BR>
	 * 
	 * @return String<BR>
	 */
	 ...
	 * Description: Increase users的角色 <BR>
	 * 
	 * @param roleId
	 * @param userIds
	 * @return String<BR>
	 ...
	 * Description: 根据records件获取所有用户 <BR>
	 * 
	 * @param userParameter
	 * @return Object<BR>
	 */
	 ...
	 * Description: Increase users界面 <BR>
	 * 
	 * @return String<BR>
	 */
